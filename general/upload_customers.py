...
if __name__ == "__main__":
    ...
    if (len(sys.argv) == 3):
        ...
        for dict in dicts:
            ...
            output_csv.append({"customer_id": new_parent_customer_id, "name": customer_name, "contact_id": new_parent_contact_id})
        conn.commit()
        ...
        print("Usage: python upload_customers.py <input_file> <output_file>")
