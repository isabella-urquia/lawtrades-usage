...
def test_get_all_categories_endpoint():
    """
    Test the GET /categories endpoint for retrieving paginated category data.
    ...
    """
    endpoint = "/categories"  # Endpoint for retrieving categories
...
@pytest.mark.integration
def test_get_categories_by_search_criteria():
    """
    Test the GET /categories endpoint with search criteria.
...
def test_delete_endpoint():
    """
    Test the DELETE /categories/{id} endpoint.
    ...
    3. The endpoint correctly handles deletion of a specific category by ID
    """
    endpoint = "/categories"
...
@pytest.mark.integration
def test_create_categories_endpoint():
    """
    Test the POST /categories endpoint.
    
    This test verifies:
    1. The endpoint returns a 200 or 201 status code for successful creation
    2. The response includes a valid transaction ID header
    3. The endpoint correctly creates a new category with the provided payload
    4. The response contains a 'success' key indicating the operation status
    
    The test creates a category with:
    - ID
    - category
    """
    endpoint = "/categories"
...
@pytest.mark.integration
def test_get_category_endpoint():
    """
    Test the GET /categories/{id} endpoint.
    
    This test verifies:
    1. The endpoint returns a 200 or 204 status code
    2. The response includes a valid transaction ID header
    3. The endpoint correctly handles retrieval of a specific product by ID
    """
    endpoint = "/categories"
    id = "b182a355-7487-47da-924f-dc67ad486b01"
    url = f"{TestBase.BASE_URL}{endpoint}/{id}"
