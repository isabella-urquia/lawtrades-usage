...
def test_get_all_items_endpoint():
    """
    Test the GET /items endpoint for retrieving paginated item data.
    ...
    """
    endpoint = "/items"  # Endpoint for retrieving items
...
@pytest.mark.integration
def test_get_items_by_search_criteria():
    """
    Test the GET /items endpoint with search criteria.
...
def test_get_item_endpoint():
    """
    Test the GET /items/{id} endpoint.
    
    This test verifies:
    1. The endpoint returns a 200 or 204 status code
    2. The response includes a valid transaction ID header
    3. The endpoint correctly handles retrieval of a specific item by ID
    """
    endpoint = "/items"
    id = "005e210f-e61f-4096-aaaf-91db881206d5"
